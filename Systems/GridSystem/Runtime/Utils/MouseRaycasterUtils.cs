...
namespace UnityTools.Systems.GridSystem.Runtime.Utils {
    public static class MouseRaycasterUtils {
        private static Vector3 lastRaycastHitPos = Vector3.zero;

        public static Vector3 GetRaycastHitPointFromMousePosition(Camera sceneCamera, float maxDistance, LayerMask layerMask) {
